...
```yaml
name: 'Kevin' # Your name or nickname
description: 'Casual Solidity Dev' # Brief personal introduction including skills and experience (One sentence)
contact_method: 'Telegram' # Contact method: Telegram | WeChat | Discord | Email | X(Twitter) | GitHub
contact: '@kevinsslin' # Your contact details, e.g., @username, email@example.com
wallet_address: 'kevinsslin.eth' # Your wallet address or ENS domain on Ethereum mainnet
