...
```yaml
name: 'Caos' # Your name or nickname
description: '8 years of blockchain development experience' # Brief personal introduction including skills and experience (One sentence)
contact_method: 'Telegram' # Contact method: Telegram | WeChat | Discord | Email | X(Twitter) | GitHub
contact: '@caosbad' # Your contact details, e.g., @username, email@example.com
wallet_address: 'caosbad.eth' # Your wallet address or ENS domain on Ethereum mainnet
...
```yaml
tech_stack: 'Node.js, React' # Planned technology stack, e.g., React, Node.js, Solidity, Hardhat, ethers.js
